...
public class OrderMapRepoTest {
    ...
    void addOrder_to_Map_products() {
        ...
        orderMapRepo.add(order4);

        int expect = 4;

        Assertions.assertEquals(expect, orderMapRepo.getOrders().size());
    }
    ...
    void removeOrder_from_arrayList_order_is_deleted() {
        ...
        Assertions.assertEquals(expectBefore, orderMapRepo.getOrders().size());
        orderMapRepo.delete(order2);
        Assertions.assertEquals(expectAfter, orderMapRepo.getOrders().size());
    ...
    void removeORder_from_arrayList_order_is_deleted_return_is_true() {
        ...
        Assertions.assertTrue(orderMapRepo.delete(order3));
    }
    ...
    void removeORder_from_arrayList_order_not_deleted_return_is_false() {
        ...
        Assertions.assertFalse(orderMapRepo.delete(order5));
    }
    ...
    void getSingleProduct_return_single_product_from_ArrayList() {
        ...
        Order singleOrderNumber = orderMapRepo.getSingle(order3.orderNumber());
    ...
    void getSingleOrder_return_single_order_not_found() {
        ...
        Order singleOrderNumber = orderMapRepo.getSingle(order5.orderNumber());
    ...
    void getAllProducts_return_ArrayList() {
        ...
        Assertions.assertEquals(expect, orderMapRepo.getAll().size());
    }

    @Test
    void getAllProducts_return_ArrayList_is_null_When_empty() {
        Assertions.assertNull(orderMapRepo.getAll());
    }
}
